  ...
  return (
    <div className="">
      ...
      <form action="contact_submit" method="get" accept-charset="utf-8">
        <fieldset id="contact_me" class="ba b--transparent ph0 mh0">
          <legend class="ph0 mh0 fw6 clip">Send</legend>
          <div class="mt3">
          ...
          <div class="mt3">
            ...
            <input class="b pa2 input-reset ba bg-transparent" type="message" name="message"  id="message"/>
          </div>
        </fieldset>
